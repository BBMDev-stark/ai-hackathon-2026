        ...
        steps: [
          {
            ...
            desc: `THÍ SINH/ĐỘI THI LỰA CHỌN 01 CHỦ ĐỀ ĐÃ ĐĂNG KÝ VÀ XÂY DỰNG:
- 01 FILE MÔ TẢ Ý TƯỞNG DỰ KIẾN TRIỂN KHAI.
- MÔ TẢ Ý TƯỞNG/SẢN PHẨM AI DỰ ĐỊNH THỰC HIỆN.
- NÊU MỤC TIÊU, ĐỐI TƯỢNG SỬ DỤNG VÀ GIÁ TRỊ MANG LẠI.

Sản phẩm gồm: Video ý tưởng + Proposal + Prompt Log + Prototype.`,
          },
          {
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8">
        ...
        <div className="mb-16 border-b border-slate-200 pb-10">
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
            ...
            <p className="text-slate-500 max-w-md text-[15px] leading-relaxed lg:text-right">
              Cuộc thi diễn ra từ tháng 4 đến tháng 5 năm 2026, bao gồm vòng sơ
              loại trực tuyến với chuỗi Workshop thực chiến và vòng Chung kết
              trực tiếp tại Đại học Lạc Hồng.
            </p>
          </div>
        </div>
          ...
          {rounds.map((round) => (
            <div key={round.id}>
              ...
              <div className="flex items-stretch gap-0 mb-8">
                ...
                >
                  <span className="text-white font-black text-2xl display tracking-tight rotate-0">
                    {round.number}
                  </span>
                </div>
                <div
                  ...
                  style={{
                    borderColor: round.accentMid,
                    backgroundColor: round.accentLight,
                  }}
                >
                  <div>
                    <span
                    ...
                    <h3 className="text-slate-900 font-bold text-xl display mt-0.5">
                      {round.title}
                    </h3>
                  </div>
                  ...
                  >
                    ...
                    <div className="divide-y divide-slate-200">
                      {phase.steps.map((step, si) => (
                        <div
                          key={si}
                          className="px-5 py-4 bg-white border-b border-slate-100 last:border-0"
                        >
                          ...
                          {"date" in step && step.date && (
                            <p className="text-[11px] font-semibold text-slate-400 mb-1.5 ml-4">
                              {step.date}
                            </p>
                          )}
                          <p className="text-[12px] text-slate-500 leading-relaxed ml-4 whitespace-pre-line">
                            {step.desc}
                          </p>
                        </div>
                      ))}
        ...
        <div className="mt-12 pt-8 border-t border-slate-100 flex flex-wrap items-center justify-between gap-4">
          <p className="text-[12px] text-slate-400">
            Địa điểm Chung kết: Hội trường B203, Trường Đại học Lạc Hồng (LHU),
            Đồng Nai.
          </p>
          <p className="text-[12px] text-slate-400">
