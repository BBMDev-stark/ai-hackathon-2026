        ...
        <div key={i} className="flex gap-5 relative">
          ...
          <div className="pb-9 flex-1">
            <div className="flex flex-wrap items-center gap-2 mb-1.5">
              <span className="text-[12px] font-bold text-azure-600">
                {item.date}
              </span>
              <span
                className={`text-[10px] font-bold px-2.5 py-0.5 rounded-full ${item.badgeColor}`}
              >
                {item.badge}
              </span>
            </div>
            <p className="text-[14px] font-semibold text-slate-800 mb-1 leading-snug">
              {item.title}
            </p>
            {item.desc && (
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8">
        <div className="mb-16">
          ...
          <p className="text-slate-500 max-w-lg text-[15px] leading-relaxed">
            Cuộc thi diễn ra qua hai giai đoạn chính từ tháng 4 đến tháng 5 năm
            2026, bao gồm vòng online và chung kết tại Đồng Nai.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-2xl border border-slate-100 p-7 sm:p-9 shadow-sm">
            ...
            <div className="flex items-center gap-2 p-3 bg-azure-50 rounded-xl border border-azure-100">
              <svg
                className="text-azure-600 shrink-0"
                width="14"
                height="14"
                fill="none"
                stroke="currentColor"
              ...
              <p className="text-[12px] text-azure-700 font-medium">
                Hội trường B203, Trường ĐH Lạc Hồng, Đồng Nai
              </p>
            </div>
          </div>
        </div>
