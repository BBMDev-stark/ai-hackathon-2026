        ...
        <div className="grid lg:grid-cols-2 gap-14 items-center">
          ...
          <div ref={leftRef} data-reveal style={{ animationDelay: "0.1s" }}>
            ...
            <div className="flex flex-wrap gap-3 mb-10">
              {[
                { icon: <svg width="14" height="14" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>, main: "Vòng 1: 23/04 – 13/05/2026", sub: "Hình thức Online" },
