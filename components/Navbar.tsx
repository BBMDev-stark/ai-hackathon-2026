    ...
    >
      <div className="max-w-7xl mx-auto px-5 sm:px-8 flex items-center justify-between h-[68px]">
        ...
        <a href="#" className="flex items-center gap-3 shrink-0">
          ...
          >
            <span className="text-white text-[11px] font-bold tracking-tight">LHU</span>
          </div>
          <div className="hidden sm:block">
            <p className={`text-[10px] leading-none transition-colors ${scrolled ? 'text-slate-400' : 'text-white/50'}`}>
              Trường Đại học Lạc Hồng
            </p>
            <p className={`text-[12px] font-semibold leading-tight transition-colors ${scrolled ? 'text-slate-800' : 'text-white'}`}>
